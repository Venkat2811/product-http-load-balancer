...
public class BackToHealthyHandler1 implements Runnable {
    ...
    //TODO: remove "lbCallMediatorMap" argument later.

    public BackToHealthyHandler1(LoadBalancerConfigContext context, LoadBalancingAlgorithm algorithm,
